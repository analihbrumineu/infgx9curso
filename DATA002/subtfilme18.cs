...
namespace GeneXus.Programs {
   public class subtfilme18 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getFilDirCodigo() > ((subtfilme18) element).getFilDirCodigo() ) return 1;
                  if ( getFilDirCodigo() < ((subtfilme18) element).getFilDirCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getFilDirNome().CompareTo(((subtfilme18) element).getFilDirNome()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setFilDirCodigo(((subtfilme18) element).getFilDirCodigo());
                  return;
               case 1 :
                  setFilDirNome(((subtfilme18) element).getFilDirNome());
                  return;
         }
      }
