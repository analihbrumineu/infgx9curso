...
namespace GeneXus.Programs {
   public class subwmovdocliente07 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getVDepende() > ((subwmovdocliente07) element).getVDepende() ) return 1;
                  if ( getVDepende() < ((subwmovdocliente07) element).getVDepende() ) return -1;
                  return 0;
               case 1 :
                  if ( getVPesCodNaGrid() > ((subwmovdocliente07) element).getVPesCodNaGrid() ) return 1;
                  if ( getVPesCodNaGrid() < ((subwmovdocliente07) element).getVPesCodNaGrid() ) return -1;
                  return 0;
               case 2 :
                  return  getVPesNomNaGrid().CompareTo(((subwmovdocliente07) element).getVPesNomNaGrid()) ;
               case 3 :
                  if ( getVTotDevolucao() > ((subwmovdocliente07) element).getVTotDevolucao() ) return 1;
                  if ( getVTotDevolucao() < ((subwmovdocliente07) element).getVTotDevolucao() ) return -1;
                  return 0;
               case 4 :
                  if ( getVTotCancelamento() > ((subwmovdocliente07) element).getVTotCancelamento() ) return 1;
                  if ( getVTotCancelamento() < ((subwmovdocliente07) element).getVTotCancelamento() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setVDepende(((subwmovdocliente07) element).getVDepende());
                  return;
               case 1 :
                  setVPesCodNaGrid(((subwmovdocliente07) element).getVPesCodNaGrid());
                  return;
               case 2 :
                  setVPesNomNaGrid(((subwmovdocliente07) element).getVPesNomNaGrid());
                  return;
               case 3 :
                  setVTotDevolucao(((subwmovdocliente07) element).getVTotDevolucao());
                  return;
               case 4 :
                  setVTotCancelamento(((subwmovdocliente07) element).getVTotCancelamento());
                  return;
         }
      }
