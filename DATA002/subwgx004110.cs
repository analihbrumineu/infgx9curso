...
namespace GeneXus.Programs {
   public class subwgx004110 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getFilDirCodigo() > ((subwgx004110) element).getFilDirCodigo() ) return 1;
                  if ( getFilDirCodigo() < ((subwgx004110) element).getFilDirCodigo() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setFilDirCodigo(((subwgx004110) element).getFilDirCodigo());
                  return;
         }
      }
