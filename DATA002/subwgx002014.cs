...
namespace GeneXus.Programs {
   public class subwgx002014 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getFilCodigo() > ((subwgx002014) element).getFilCodigo() ) return 1;
                  if ( getFilCodigo() < ((subwgx002014) element).getFilCodigo() ) return -1;
                  return 0;
               case 1 :
                  if ( getFilSituacao() > ((subwgx002014) element).getFilSituacao() ) return 1;
                  if ( getFilSituacao() < ((subwgx002014) element).getFilSituacao() ) return -1;
                  return 0;
               case 2 :
                  return GXutil.datecmp( GxConvert.AnyDateToJDate(getFilData()) , GxConvert.AnyDateToJDate(((subwgx002014) element).getFilData()) );
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setFilCodigo(((subwgx002014) element).getFilCodigo());
                  return;
               case 1 :
                  setFilSituacao(((subwgx002014) element).getFilSituacao());
                  setFilSituacaoDescription(((subwgx002014) element).getFilSituacaoDescription());
                  return;
               case 2 :
                  setFilData(((subwgx002014) element).getFilData());
                  return;
         }
      }
