...
namespace GeneXus.Programs {
   public class subwgx006010 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getCidCodigo() > ((subwgx006010) element).getCidCodigo() ) return 1;
                  if ( getCidCodigo() < ((subwgx006010) element).getCidCodigo() ) return -1;
                  return 0;
               case 1 :
                  if ( getEstCodigo() > ((subwgx006010) element).getEstCodigo() ) return 1;
                  if ( getEstCodigo() < ((subwgx006010) element).getEstCodigo() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setCidCodigo(((subwgx006010) element).getCidCodigo());
                  return;
               case 1 :
                  setEstCodigo(((subwgx006010) element).getEstCodigo());
                  return;
         }
      }
