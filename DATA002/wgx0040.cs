/*
               File: Gx0040
        Description: Lista de Seleção Cadastro de categorias.
             Author: GeneXus C# Generator version 9_0_7-910
       Generated on: 5/26/2026 9:33:37.43
...
namespace GeneXus.Programs {
   public class wgx0040 : GXWorkpanel
   {
      public wgx0040( int hnd ,
      ...
      public wgx0040( IGxContext context ) : base(-1, null)
      {
      ...
      public wgx0040( IGxContext context ,
                      int hnd ,
                      ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      {
         return "Lista de Seleção Cadastro de categorias." ;
      }
      ...
      public class Gx0040_load08 : GXLoadProducer
      {
         wgx0040 _sf ;

         public Gx0040_load08( wgx0040 uType ) : base()
         {
            _sf = uType;
         }
      ...
      public class Gx0040_flow08 : GXSubfileFlow
      {
         wgx0040 _sf ;

         public Gx0040_flow08( wgx0040 uType ) : base()
         {
            _sf = uType;
         }
      ...
      {
         subwgx004008 oAux = subwgx004008 ;
         subwgx004008 = new subwgx004008 ();
         variablesToSubfile08 ();
         subGrd_1.addElement(subwgx004008);
         subwgx004008 = oAux;
      }

      private void E11V202( )
      {
         /* Load Routine */
      ...
      public override void screen( )
      {
         ...
         edtavCcatcodigo.getGXComponent().setHelpId("HLP_WGx0040.htm");
         addSubfile ( subGrd_1  = new GXSubfile ( new Gx0040_load08(this), new Gx0040_flow08(this), false , new GXColumnDefinition[] {
         ...
         lbllbl7 = UIFactory.getLabel(GXPanel1, "Código da categoria do filme", ILabelConstants.LEFT, Integer.MAX_VALUE, UIFactory.getColor(8), UIFactory.getFont( "MS Sans Serif", IFontConstants.BOLD, 8), false, ILabelConstants.BORDER_NONE , 21 , 24 , 163 , 13 );
      ...
      {
         subwgx004008.setCatCodigo(A32CatCodi);
      }

      protected void subfileToVariables08( )
      {
         A32CatCodi = subwgx004008.getCatCodigo();
      }
      ...
      public override void eventLevelContext( )
      {
         ...
         {
            subwgx004008 = ( subwgx004008 ) subGrd_1.getCurrentElement() ;
         }
         else
         {
            subwgx004008 = new subwgx004008 ();
      ...
      {
         variablesToSubfile08 ();
         subGrd_1.refreshLineValue(subwgx004008);
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         AV5cCatCod = 0 ;
         W00202_A32CatCodi = new int[1] ;
         A32CatCodi = 0 ;
         gxIsRefreshing = false ;
         cV5cCatCod = 0 ;
         returnInSub = false ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wgx0040__default(),
            new Object[][] {
                new Object[] {
               W00202_A32CatCodi
               }
      ...
      protected subwgx004008 subwgx004008 ;
      protected IDataReader W00202 ;
      protected IDataStoreProvider pr_default ;
      protected int[] W00202_A32CatCodi ;
   ...
   public class wgx0040__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmW00202 ;
          prmW00202 = new Object[] {
          new Object[] {"@AV5cCatCod",SqlDbType.Int,9,0}
          } ;
          def= new GeneXus.Data.NTier.ADO.CursorDef[] {
              new GeneXus.Data.NTier.ADO.CursorDef("W00202", "SELECT [CatCodigo] FROM [CATEGORIA] WITH (NOLOCK) WHERE [CatCodigo] >= @AV5cCatCod ORDER BY [CatCodigo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmW00202,9,0,true,false )
          };
       }
    }
