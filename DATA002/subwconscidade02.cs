...
namespace GeneXus.Programs {
   public class subwconscidade02 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getCidCodigo() > ((subwconscidade02) element).getCidCodigo() ) return 1;
                  if ( getCidCodigo() < ((subwconscidade02) element).getCidCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getEstUF().CompareTo(((subwconscidade02) element).getEstUF()) ;
               case 2 :
                  return  getCidNome().CompareTo(((subwconscidade02) element).getCidNome()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setCidCodigo(((subwconscidade02) element).getCidCodigo());
                  return;
               case 1 :
                  setEstUF(((subwconscidade02) element).getEstUF());
                  return;
               case 2 :
                  setCidNome(((subwconscidade02) element).getCidNome());
                  return;
         }
      }
