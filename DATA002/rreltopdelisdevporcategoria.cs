/*
       ...
       Generated on: 6/11/2026 11:31:26.32
...
namespace GeneXus.Programs {
   public class rreltopdelisdevporcategoria_wrapper : GXJWin
   {
      public rreltopdelisdevporcategoria_wrapper( int hnd ,
   ...
   public class rreltopdelisdevporcategoria : GXWinProcedure
   {
      public rreltopdelisdevporcategoria( int hnd ,
                                          ModelContext jContext ) : base(hnd, jContext)
      {
         IsMain = true;
      ...
      public rreltopdelisdevporcategoria( )
      {
         context = new GxContext(  );
         DataStoreUtil.LoadDataStores( context);
         dsDefault = context.GetDataStore("Default") ;
      ...
      public rreltopdelisdevporcategoria( IGxContext context ) : base(-1, null)
      {
      ...
      public rreltopdelisdevporcategoria( IGxContext context ,
                                          int hnd ,
                                          ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      public void executeSubmit( DateTime aP0_DatInicial ,
                                 ...
                                 long aP2_Selecao )
      {
         rreltopdelisdevporcategoria objrreltopdelisdevporcategoria;
         objrreltopdelisdevporcategoria = new rreltopdelisdevporcategoria();
         objrreltopdelisdevporcategoria.AV8DatInic = aP0_DatInicial;
         objrreltopdelisdevporcategoria.AV9DatFina = aP1_DatFinal;
         objrreltopdelisdevporcategoria.AV10Seleca = aP2_Selecao;
         objrreltopdelisdevporcategoria.initialize();
         ThreadPool.QueueUserWorkItem( new WaitCallback( objrreltopdelisdevporcategoria.executePrivateCatch ));
      }
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            getPrinter().GxSetDocName("Relatório de topo de lista de devoluções por categoria.") ;
            ...
            {
               BRK0Q3 = false ;
               A86LocCodi = R000Q2_A86LocCodi[0] ;
               A89LocDatD = R000Q2_A89LocDatD[0] ;
               n89LocDatD = R000Q2_n89LocDatD[0] ;
               A105LocMid = R000Q2_A105LocMid[0] ;
               n105LocMid = R000Q2_n105LocMid[0] ;
               A118LocMid = R000Q2_A118LocMid[0] ;
               n118LocMid = R000Q2_n118LocMid[0] ;
               A89LocDatD = R000Q2_A89LocDatD[0] ;
               n89LocDatD = R000Q2_n89LocDatD[0] ;
               A118LocMid = R000Q2_A118LocMid[0] ;
               n118LocMid = R000Q2_n118LocMid[0] ;
                           ...
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( ( Gx_line + Inc >= P_lines ) )
            {
               ...
               getPrinter().GxDrawText("Categoria", 26, Gx_line+182, 80, Gx_line+195, 0+256) ;
      ...
      private bool doAsk( )
      {
         GXAsk ask = new GXAsk( "Relatório de topo de lista de devoluções por categoria." , true , new GXAskObject[] {
         });
      ...
      public override void initialize( )
      {
         ...
         R000Q2_A89LocDatD = new DateTime[] {DateTime.MinValue} ;
         R000Q2_n89LocDatD = new bool[] {false} ;
         R000Q2_A105LocMid = new int[1] ;
         R000Q2_n105LocMid = new bool[] {false} ;
         R000Q2_A118LocMid = new String[] {""} ;
         R000Q2_n118LocMid = new bool[] {false} ;
         BRK0Q3 = false ;
         A86LocCodi = 0 ;
         ...
         Gx_time = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rreltopdelisdevporcategoria__default(),
            new Object[][] {
                new Object[] {
               R000Q2_A102LocMid, R000Q2_A86LocCodi, R000Q2_A89LocDatD, R000Q2_n89LocDatD, R000Q2_A105LocMid, R000Q2_n105LocMid, R000Q2_A118LocMid, R000Q2_n118LocMid
               }
            }
         );
         /* GeneXus formulas. */
         ...
         AV20Pgmdes = "Relatório de topo de lista de devoluções por categoria." ;
         context.Gx_err = 0 ;
      ...
      private IDataReader R000Q2 ;
      private IDataStoreProvider pr_default ;
      private int[] R000Q2_A102LocMid ;
      private int[] R000Q2_A86LocCodi ;
      private DateTime[] R000Q2_A89LocDatD ;
      private bool[] R000Q2_n89LocDatD ;
      private int[] R000Q2_A105LocMid ;
      private bool[] R000Q2_n105LocMid ;
   ...
   public class rreltopdelisdevporcategoria__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmR000Q2 ;
          prmR000Q2 = new Object[] {
          } ;
          def= new GeneXus.Data.NTier.ADO.CursorDef[] {
              new GeneXus.Data.NTier.ADO.CursorDef("R000Q2", "SELECT T1.[LocMidMidCodigo], T1.[LocCodigo], T2.[LocDatDevolucao], T1.[LocMidCatCodigo] AS LocMidCatCodigo, T3.[CatNome] AS LocMidCatNome FROM (([LOCACAOLOCACAOMIDIA] T1 WITH (NOLOCK) INNER JOIN [LOCACAO] T2 WITH (NOLOCK) ON T2.[LocCodigo] = T1.[LocCodigo]) LEFT JOIN [CATEGORIA] T3 WITH (NOLOCK) ON T3.[CatCodigo] = T1.[LocMidCatCodigo]) ORDER BY T1.[LocMidCatCodigo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmR000Q2,100,0,true,false )
          };
       }
    }
