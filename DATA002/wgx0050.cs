/*
       ...
       Generated on: 5/26/2026 9:33:37.47
...
namespace GeneXus.Programs {
   public class wgx0050 : GXWorkpanel
   {
      public wgx0050( int hnd ,
      ...
      public wgx0050( IGxContext context ) : base(-1, null)
      {
      ...
      public wgx0050( IGxContext context ,
                      int hnd ,
                      ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      public void runLoad_load10( )
      {
         ...
         {
            A25EstUF = W001I2_A25EstUF[0] ;
            A24EstCodi = W001I2_A24EstCodi[0] ;
            /* Execute user event: E11V1I2 */
            E11V1I2 ();
      ...
      public class Gx0050_load10 : GXLoadProducer
      {
         wgx0050 _sf ;

         public Gx0050_load10( wgx0050 uType ) : base()
         {
            _sf = uType;
         }
      ...
      public class Gx0050_flow10 : GXSubfileFlow
      {
         wgx0050 _sf ;

         public Gx0050_flow10( wgx0050 uType ) : base()
         {
            _sf = uType;
         }
      ...
      {
         subwgx005010 oAux = subwgx005010 ;
         subwgx005010 = new subwgx005010 ();
         variablesToSubfile10 ();
         subGrd_1.addElement(subwgx005010);
         subwgx005010 = oAux;
      }

      private void E11V1I2( )
      {
         /* Load Routine */
      ...
      public override void screen( )
      {
         ...
         edtavCestcodigo.getGXComponent().setHelpId("HLP_WGx0050.htm");
         ...
         edtavCestuf.getGXComponent().setHelpId("HLP_WGx0050.htm");
         addSubfile ( subGrd_1  = new GXSubfile ( new Gx0050_load10(this), new Gx0050_flow10(this), false , new GXColumnDefinition[] {
         ...
         lbllbl7 = UIFactory.getLabel(GXPanel1, "Código do Estado da pessoa.", ILabelConstants.LEFT, Integer.MAX_VALUE, UIFactory.getColor(8), UIFactory.getFont( "MS Sans Serif", IFontConstants.BOLD, 8), false, ILabelConstants.BORDER_NONE , 21 , 24 , 167 , 13 );
         lbllbl9 = UIFactory.getLabel(GXPanel1, "UF do Estado da pessoa.", ILabelConstants.LEFT, Integer.MAX_VALUE, UIFactory.getColor(8), UIFactory.getFont( "MS Sans Serif", IFontConstants.BOLD, 8), false, ILabelConstants.BORDER_NONE , 21 , 48 , 144 , 13 );
      ...
      {
         subwgx005010.setEstCodigo(A24EstCodi);
         subwgx005010.setEstUF(A25EstUF);
      }

      protected void subfileToVariables10( )
      {
         A24EstCodi = subwgx005010.getEstCodigo();
         A25EstUF = subwgx005010.getEstUF();
      }
      ...
      public override void eventLevelContext( )
      {
         ...
         {
            subwgx005010 = ( subwgx005010 ) subGrd_1.getCurrentElement() ;
         }
         else
         {
            subwgx005010 = new subwgx005010 ();
      ...
      {
         variablesToSubfile10 ();
         subGrd_1.refreshLineValue(subwgx005010);
      }
      ...
      public override void initialize( )
      {
         ...
         AV6cEstUF = "" ;
         AV5cEstCod = 0 ;
         W001I2_A25EstUF = new String[] {""} ;
         W001I2_A24EstCodi = new int[1] ;
         A25EstUF = "" ;
         A24EstCodi = 0 ;
         gxIsRefreshing = false ;
         cV5cEstCod = 0 ;
         cV6cEstUF = "" ;
         returnInSub = false ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wgx0050__default(),
            new Object[][] {
                new Object[] {
               W001I2_A25EstUF, W001I2_A24EstCodi
               }
            }
         );
      ...
      protected subwgx005010 subwgx005010 ;
      protected IDataReader W001I2 ;
      protected IDataStoreProvider pr_default ;
      protected String[] W001I2_A25EstUF ;
      protected int[] W001I2_A24EstCodi ;
   ...
   public class wgx0050__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmW001I2 ;
          prmW001I2 = new Object[] {
          new Object[] {"@AV5cEstCod",SqlDbType.Int,9,0} ,
          new Object[] {"@AV6cEstUF",SqlDbType.Char,2,0}
          } ;
          def= new GeneXus.Data.NTier.ADO.CursorDef[] {
              new GeneXus.Data.NTier.ADO.CursorDef("W001I2", "SELECT [EstUF], [EstCodigo] FROM [ESTADO] WITH (NOLOCK) WHERE ([EstCodigo] >= @AV5cEstCod) AND ([EstUF] like @AV6cEstUF) ORDER BY [EstCodigo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmW001I2,9,0,true,false )
          };
       }
    }
