...
namespace GeneXus.Programs {
   public class subwgx00b111 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getFilAtoCodigo() > ((subwgx00b111) element).getFilAtoCodigo() ) return 1;
                  if ( getFilAtoCodigo() < ((subwgx00b111) element).getFilAtoCodigo() ) return -1;
                  return 0;
               case 1 :
                  if ( getFilAtoProt() > ((subwgx00b111) element).getFilAtoProt() ) return 1;
                  if ( getFilAtoProt() < ((subwgx00b111) element).getFilAtoProt() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setFilAtoCodigo(((subwgx00b111) element).getFilAtoCodigo());
                  return;
               case 1 :
                  setFilAtoProt(((subwgx00b111) element).getFilAtoProt());
                  return;
         }
      }
