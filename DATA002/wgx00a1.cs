/*
               File: Gx00A1
        Description: Lista de Seleção Direcao
             Author: GeneXus C# Generator version 9_0_7-910
       Generated on: 5/26/2026 9:33:37.60
...
namespace GeneXus.Programs {
   public class wgx00a1 : GXWorkpanel
   {
      public wgx00a1( int hnd ,
      ...
      public wgx00a1( IGxContext context ) : base(-1, null)
      {
      ...
      public wgx00a1( IGxContext context ,
                      int hnd ,
                      ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      {
         return "Lista de Seleção Direcao" ;
      }
      ...
      public class Gx00A1_load10 : GXLoadProducer
      {
         wgx00a1 _sf ;

         public Gx00A1_load10( wgx00a1 uType ) : base()
         {
            _sf = uType;
         }
      ...
      public class Gx00A1_flow10 : GXSubfileFlow
      {
         wgx00a1 _sf ;

         public Gx00A1_flow10( wgx00a1 uType ) : base()
         {
            _sf = uType;
         }
      ...
      {
         subwgx00a110 oAux = subwgx00a110 ;
         subwgx00a110 = new subwgx00a110 ();
         variablesToSubfile10 ();
         subGrd_1.addElement(subwgx00a110);
         subwgx00a110 = oAux;
      }

      private void E11V222( )
      {
         /* Load Routine */
      ...
      public override void screen( )
      {
         ...
         edtFilCodigo.getGXComponent().setHelpId("HLP_WGx00A1.htm");
         ...
         edtavCfildircodigo.getGXComponent().setHelpId("HLP_WGx00A1.htm");
         addSubfile ( subGrd_1  = new GXSubfile ( new Gx00A1_load10(this), new Gx00A1_flow10(this), false , new GXColumnDefinition[] {
      ...
      {
         subwgx00a110.setFilDirCodigo(A79FilDirC);
         subwgx00a110.setFilCodigo(A28FilCodi);
      }

      protected void subfileToVariables10( )
      {
         A79FilDirC = subwgx00a110.getFilDirCodigo();
         A28FilCodi = subwgx00a110.getFilCodigo();
      }
      ...
      public override void eventLevelContext( )
      {
         ...
         {
            subwgx00a110 = ( subwgx00a110 ) subGrd_1.getCurrentElement() ;
         }
         else
         {
            subwgx00a110 = new subwgx00a110 ();
      ...
      {
         variablesToSubfile10 ();
         subGrd_1.refreshLineValue(subwgx00a110);
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         AV5cFilDir = 0 ;
         W00222_A28FilCodi = new int[1] ;
         W00222_A79FilDirC = new int[1] ;
         A79FilDirC = 0 ;
         gxIsRefreshing = false ;
         cV5cFilDir = 0 ;
         returnInSub = false ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wgx00a1__default(),
            new Object[][] {
                new Object[] {
               W00222_A28FilCodi, W00222_A79FilDirC
               }
            }
         );
      ...
      protected subwgx00a110 subwgx00a110 ;
      protected IDataReader W00222 ;
      protected IDataStoreProvider pr_default ;
      protected int[] W00222_A28FilCodi ;
      protected int[] W00222_A79FilDirC ;
   ...
   public class wgx00a1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmW00222 ;
          prmW00222 = new Object[] {
          new Object[] {"@FilCodigo",SqlDbType.Int,9,0} ,
          new Object[] {"@AV5cFilDir",SqlDbType.Int,9,0}
          } ;
          def= new GeneXus.Data.NTier.ADO.CursorDef[] {
              new GeneXus.Data.NTier.ADO.CursorDef("W00222", "SELECT [FilCodigo], [FilDirCodigo] FROM [FILMEDIRECAO] WITH (NOLOCK) WHERE [FilCodigo] = @FilCodigo and [FilDirCodigo] >= @AV5cFilDir ORDER BY [FilCodigo], [FilDirCodigo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmW00222,9,0,true,false )
          };
       }
    }
