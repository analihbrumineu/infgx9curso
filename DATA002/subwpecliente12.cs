...
namespace GeneXus.Programs {
   public class subwpecliente12 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  return  getVEditar().CompareTo(((subwpecliente12) element).getVEditar()) ;
               case 1 :
                  return  getVExcluir().CompareTo(((subwpecliente12) element).getVExcluir()) ;
               case 2 :
                  if ( getPesCodigo() > ((subwpecliente12) element).getPesCodigo() ) return 1;
                  if ( getPesCodigo() < ((subwpecliente12) element).getPesCodigo() ) return -1;
                  return 0;
               case 3 :
                  return  getPesNome().CompareTo(((subwpecliente12) element).getPesNome()) ;
               case 4 :
                  if ( getPesDepTotal() > ((subwpecliente12) element).getPesDepTotal() ) return 1;
                  if ( getPesDepTotal() < ((subwpecliente12) element).getPesDepTotal() ) return -1;
                  return 0;
               case 5 :
                  if ( getPesSituacao() > ((subwpecliente12) element).getPesSituacao() ) return 1;
                  if ( getPesSituacao() < ((subwpecliente12) element).getPesSituacao() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setVEditar(((subwpecliente12) element).getVEditar());
                  return;
               case 1 :
                  setVExcluir(((subwpecliente12) element).getVExcluir());
                  return;
               case 2 :
                  setPesCodigo(((subwpecliente12) element).getPesCodigo());
                  return;
               case 3 :
                  setPesNome(((subwpecliente12) element).getPesNome());
                  return;
               case 4 :
                  setPesDepTotal(((subwpecliente12) element).getPesDepTotal());
                  return;
               case 5 :
                  setPesSituacao(((subwpecliente12) element).getPesSituacao());
                  setPesSituacaoDescription(((subwpecliente12) element).getPesSituacaoDescription());
                  return;
         }
      }
