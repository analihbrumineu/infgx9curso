/*
       ...
       Generated on: 6/10/2026 9:22:30.63
         ...
         try
         {
            ...
            while ( ( AV26GXV1 <= AV14Midias.Count ) )
            {
               ...
               if ( ( AV16ContSe < AV10Seleca ) )
               {
                  ...
                  getPrinter().GxDrawText(StringUtil.RTrim( StringUtil.Format( AV11LocMid, "@!")), 26, Gx_line+13, 207, Gx_line+28, 0) ;
                  Gx_OldLine = Gx_line ;
                           ...
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( ( Gx_line + Inc >= P_lines ) )
            {
               ...
               getPrinter().GxDrawText(StringUtil.RTrim( StringUtil.Format( AV21Pgmdes, "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")), 117, Gx_line+52, 610, Gx_line+67, 0) ;
