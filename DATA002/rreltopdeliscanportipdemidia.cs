/*
       ...
       Generated on: 6/12/2026 11:52:29.28
...
namespace GeneXus.Programs {
   public class rreltopdeliscanportipdemidia_wrapper : GXJWin
   {
      public rreltopdeliscanportipdemidia_wrapper( int hnd ,
   ...
   public class rreltopdeliscanportipdemidia : GXWinProcedure
   {
      public rreltopdeliscanportipdemidia( int hnd ,
                                           ModelContext jContext ) : base(hnd, jContext)
      {
         IsMain = true;
      ...
      public rreltopdeliscanportipdemidia( )
      {
         context = new GxContext(  );
         DataStoreUtil.LoadDataStores( context);
         dsDefault = context.GetDataStore("Default") ;
      ...
      public rreltopdeliscanportipdemidia( IGxContext context ) : base(-1, null)
      {
      ...
      public rreltopdeliscanportipdemidia( IGxContext context ,
                                           int hnd ,
                                           ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      public void executeSubmit( DateTime aP0_DatInicial ,
                                 ...
                                 long aP2_Selecao )
      {
         rreltopdeliscanportipdemidia objrreltopdeliscanportipdemidia;
         objrreltopdeliscanportipdemidia = new rreltopdeliscanportipdemidia();
         objrreltopdeliscanportipdemidia.AV8DatInic = aP0_DatInicial;
         objrreltopdeliscanportipdemidia.AV9DatFina = aP1_DatFinal;
         objrreltopdeliscanportipdemidia.AV10Seleca = aP2_Selecao;
         objrreltopdeliscanportipdemidia.initialize();
         ThreadPool.QueueUserWorkItem( new WaitCallback( objrreltopdeliscanportipdemidia.executePrivateCatch ));
      }
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            getPrinter().GxSetDocName("Relatório de topo de lista sobre cancelamentos por formato de mídia.") ;
            ...
            {
               BRK0U3 = false ;
               A86LocCodi = R000U2_A86LocCodi[0] ;
               A90LocDatC = R000U2_A90LocDatC[0] ;
               n90LocDatC = R000U2_n90LocDatC[0] ;
               A106LocMid = R000U2_A106LocMid[0] ;
               n106LocMid = R000U2_n106LocMid[0] ;
               A102LocMid = R000U2_A102LocMid[0] ;
               A90LocDatC = R000U2_A90LocDatC[0] ;
               n90LocDatC = R000U2_n90LocDatC[0] ;
               if ( ( A90LocDatC >= AV8DatInic ) && ( A90LocDatC <= AV9DatFina ) && ( A90LocDatC != DateTimeUtil.CToD( "0", 2) ) )
               {
                  ...
                  while ( (pr_default.getStatus(0) != 101) && ( R000U2_A106LocMid[0] == A106LocMid ) )
                  {
                     BRK0U3 = false ;
                     A86LocCodi = R000U2_A86LocCodi[0] ;
                     A90LocDatC = R000U2_A90LocDatC[0] ;
            ...
            while ( ( AV26GXV1 <= AV14Midias.Count ) )
            {
               ...
               {
                  AV17LocMid = AV15Item.gxTpr_Midtiprellocmidmidtipo ;
                  if ( ( AV17LocMid == 1 ) )
                  {
                     AV11LocMid = "DVD" ;
                  }
                  else if ( ( AV17LocMid == 2 ) )
                  {
                     AV11LocMid = "Bluray" ;
                  }
                  else if ( ( AV17LocMid == 3 ) )
                  {
                     AV11LocMid = "VHS" ;
                  }
                  else if ( ( AV17LocMid == 4 ) )
                  {
                     AV11LocMid = "Box" ;
                  }
                  H0U0( false, 39) ;
                  getPrinter().GxAttris("Courier New", 9, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( StringUtil.Format( AV11LocMid, "@!")), 39, Gx_line+13, 220, Gx_line+28, 0) ;
                  Gx_OldLine = Gx_line ;
      ...
      private bool doAsk( )
      {
         GXAsk ask = new GXAsk( "Relatório de topo de lista sobre cancelamentos por formato de mídia." , true , new GXAskObject[] {
         });
      ...
      public override void initialize( )
      {
         ...
         AV14Midias = new GxObjectCollection( context, "SDTMidTipRelatorio.SDTMidTipDevRelatorioItem", "AgoraVaiCurso", "SdtSDTMidTipRelatorio_SDTMidTipDevRelatorioItem", "GeneXus.Programs");
         scmdbuf = "" ;
         R000U2_A86LocCodi = new int[1] ;
         R000U2_A90LocDatC = new DateTime[] {DateTime.MinValue} ;
         R000U2_n90LocDatC = new bool[] {false} ;
         R000U2_A106LocMid = new short[1] ;
         R000U2_n106LocMid = new bool[] {false} ;
         R000U2_A102LocMid = new int[1] ;
         BRK0U3 = false ;
         A86LocCodi = 0 ;
         ...
         Gx_time = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rreltopdeliscanportipdemidia__default(),
            new Object[][] {
                new Object[] {
               R000U2_A86LocCodi, R000U2_A90LocDatC, R000U2_n90LocDatC, R000U2_A106LocMid, R000U2_n106LocMid, R000U2_A102LocMid
               }
            }
         );
         /* GeneXus formulas. */
         ...
         AV21Pgmdes = "Relatório de topo de lista sobre cancelamentos por formato de mídia." ;
         context.Gx_err = 0 ;
      ...
      private IDataReader R000U2 ;
      private IDataStoreProvider pr_default ;
      private int[] R000U2_A86LocCodi ;
      private DateTime[] R000U2_A90LocDatC ;
      private bool[] R000U2_n90LocDatC ;
      private short[] R000U2_A106LocMid ;
      private bool[] R000U2_n106LocMid ;
      private int[] R000U2_A102LocMid ;
      private GxObjectCollection AV14Midias ;
      private SdtSDTMidTipRelatorio_SDTMidTipDevRelatorioItem AV15Item ;
   }

   public class rreltopdeliscanportipdemidia__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmR000U2 ;
          prmR000U2 = new Object[] {
          } ;
          def= new GeneXus.Data.NTier.ADO.CursorDef[] {
              new GeneXus.Data.NTier.ADO.CursorDef("R000U2", "SELECT T1.[LocCodigo], T2.[LocDatCancelamento], T1.[LocMidMidTipo], T1.[LocMidMidCodigo] FROM ([LOCACAOLOCACAOMIDIA] T1 WITH (NOLOCK) INNER JOIN [LOCACAO] T2 WITH (NOLOCK) ON T2.[LocCodigo] = T1.[LocCodigo]) ORDER BY T1.[LocMidMidTipo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmR000U2,100,0,true,false )
          };
       }
    }
