...
namespace GeneXus.Programs {
   public class subwgx00c020 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getLocCodigo() > ((subwgx00c020) element).getLocCodigo() ) return 1;
                  if ( getLocCodigo() < ((subwgx00c020) element).getLocCodigo() ) return -1;
                  return 0;
               case 1 :
                  if ( getLocSituacao() > ((subwgx00c020) element).getLocSituacao() ) return 1;
                  if ( getLocSituacao() < ((subwgx00c020) element).getLocSituacao() ) return -1;
                  return 0;
               case 2 :
                  return GXutil.datecmp( GxConvert.AnyDateToJDate(getLocDatLocacao()) , GxConvert.AnyDateToJDate(((subwgx00c020) element).getLocDatLocacao()) );
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setLocCodigo(((subwgx00c020) element).getLocCodigo());
                  return;
               case 1 :
                  setLocSituacao(((subwgx00c020) element).getLocSituacao());
                  setLocSituacaoDescription(((subwgx00c020) element).getLocSituacaoDescription());
                  return;
               case 2 :
                  setLocDatLocacao(((subwgx00c020) element).getLocDatLocacao());
                  return;
         }
      }
