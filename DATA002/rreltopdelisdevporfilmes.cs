/*
       ...
       Generated on: 6/10/2026 8:56:37.30
...
namespace GeneXus.Programs {
   public class rreltopdelisdevporfilmes_wrapper : GXJWin
   {
      public rreltopdelisdevporfilmes_wrapper( int hnd ,
   ...
   public class rreltopdelisdevporfilmes : GXWinProcedure
   {
      public rreltopdelisdevporfilmes( int hnd ,
                                       ModelContext jContext ) : base(hnd, jContext)
      {
         IsMain = true;
      ...
      public rreltopdelisdevporfilmes( )
      {
         context = new GxContext(  );
         DataStoreUtil.LoadDataStores( context);
         dsDefault = context.GetDataStore("Default") ;
      ...
      public rreltopdelisdevporfilmes( IGxContext context ) : base(-1, null)
      {
      ...
      public rreltopdelisdevporfilmes( IGxContext context ,
                                       int hnd ,
                                       ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      public void executeSubmit( DateTime aP0_DatInicial ,
                                 ...
                                 long aP2_Selecao )
      {
         rreltopdelisdevporfilmes objrreltopdelisdevporfilmes;
         objrreltopdelisdevporfilmes = new rreltopdelisdevporfilmes();
         objrreltopdelisdevporfilmes.AV8DatInic = aP0_DatInicial;
         objrreltopdelisdevporfilmes.AV9DatFina = aP1_DatFinal;
         objrreltopdelisdevporfilmes.AV10Seleca = aP2_Selecao;
         objrreltopdelisdevporfilmes.initialize();
         ThreadPool.QueueUserWorkItem( new WaitCallback( objrreltopdelisdevporfilmes.executePrivateCatch ));
      }
      ...
      public override void initialize( )
      {
         ...
         Gx_time = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rreltopdelisdevporfilmes__default(),
            new Object[][] {
                new Object[] {
