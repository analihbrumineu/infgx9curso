...
namespace GeneXus.Programs {
   public class subtlocacao29 : GXSubfileElement
   {
      ...
      private decimal LocMidLocMidValor ;
      ...
      private decimal ZLocMidLocMidValor ;
      ...
      public decimal getLocMidLocMidValor( )
      {
         return LocMidLocMidValor ;
      }

      public void setLocMidLocMidValor( decimal value )
      {
         LocMidLocMidValor = value;
      }
      ...
      public decimal getZLocMidLocMidValor( )
      {
         return ZLocMidLocMidValor ;
      }

      public void setZLocMidLocMidValor( decimal value )
      {
         ZLocMidLocMidValor = value;
      }
      ...
      public override void clear( )
      {
         ...
         LocMidLocMidValor = 0M ;
         ZLocMidFilCodigo = 0 ;
         ZLocMidFilNome = "" ;
         ZLocMidCatCodigo = 0 ;
         ZLocMidMidTipo = 0 ;
         ZLocMidMidConfValor = 0M ;
         ZLocMidLocMidValor = 0M ;
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getLocMidMidCodigo() > ((subtlocacao29) element).getLocMidMidCodigo() ) return 1;
                  if ( getLocMidMidCodigo() < ((subtlocacao29) element).getLocMidMidCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getLocMidFilNome().CompareTo(((subtlocacao29) element).getLocMidFilNome()) ;
               case 2 :
                  if ( getLocMidMidTipo() > ((subtlocacao29) element).getLocMidMidTipo() ) return 1;
                  if ( getLocMidMidTipo() < ((subtlocacao29) element).getLocMidMidTipo() ) return -1;
                  return 0;
               case 3 :
                  if ( getLocMidMidConfValor() > ((subtlocacao29) element).getLocMidMidConfValor() ) return 1;
                  if ( getLocMidMidConfValor() < ((subtlocacao29) element).getLocMidMidConfValor() ) return -1;
                  return 0;
         }
         return 0;
      ...
      public override int isChanged( )
      {
         ...
         && (ZLocMidLocMidValor == LocMidLocMidValor)
         ))?0:1;
      }

      public override bool isEmpty( )
      {
         return ( ( getLocMidMidCodigo() == 0 ) && ( String.CompareOrdinal(getLocMidFilNome().TrimEnd(' '), "".TrimEnd(' ') ) == 0 ) && ( getLocMidMidTipo() == 0 ) && ( getLocMidMidConfValor() == Convert.ToDecimal( 0M )) && ( getLocMidFilCodigo() == 0 ) && ( getLocMidCatCodigo() == 0 ) && ( getLocMidMidSituacao() == 0 ) && ( getLocMidMidLocCodigo() == 0 ) && ( getLocMidLocMidValor() == Convert.ToDecimal( 0M )) || insertedNotUserModified() )  ;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setLocMidMidCodigo(((subtlocacao29) element).getLocMidMidCodigo());
                  return;
               case 1 :
                  setLocMidFilNome(((subtlocacao29) element).getLocMidFilNome());
                  return;
               case 2 :
                  setLocMidMidTipo(((subtlocacao29) element).getLocMidMidTipo());
                  setLocMidMidTipoDescription(((subtlocacao29) element).getLocMidMidTipoDescription());
                  return;
               case 3 :
                  setLocMidMidConfValor(((subtlocacao29) element).getLocMidMidConfValor());
                  return;
         }
      }
