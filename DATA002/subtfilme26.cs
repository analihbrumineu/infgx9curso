...
namespace GeneXus.Programs {
   public class subtfilme26 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getFilAtoCodigo() > ((subtfilme26) element).getFilAtoCodigo() ) return 1;
                  if ( getFilAtoCodigo() < ((subtfilme26) element).getFilAtoCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getFilAtoNome().CompareTo(((subtfilme26) element).getFilAtoNome()) ;
               case 2 :
                  if ( getFilAtoProt() > ((subtfilme26) element).getFilAtoProt() ) return 1;
                  if ( getFilAtoProt() < ((subtfilme26) element).getFilAtoProt() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setFilAtoCodigo(((subtfilme26) element).getFilAtoCodigo());
                  return;
               case 1 :
                  setFilAtoNome(((subtfilme26) element).getFilAtoNome());
                  return;
               case 2 :
                  setFilAtoProt(((subtfilme26) element).getFilAtoProt());
                  return;
         }
      }
