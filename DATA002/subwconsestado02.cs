...
namespace GeneXus.Programs {
   public class subwconsestado02 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getEstCodigo() > ((subwconsestado02) element).getEstCodigo() ) return 1;
                  if ( getEstCodigo() < ((subwconsestado02) element).getEstCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getEstUF().CompareTo(((subwconsestado02) element).getEstUF()) ;
               case 2 :
                  return  getEstNome().CompareTo(((subwconsestado02) element).getEstNome()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setEstCodigo(((subwconsestado02) element).getEstCodigo());
                  return;
               case 1 :
                  setEstUF(((subwconsestado02) element).getEstUF());
                  return;
               case 2 :
                  setEstNome(((subwconsestado02) element).getEstNome());
                  return;
         }
      }
