...
namespace GeneXus.Programs {
   public class subwconsfuncionario13 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getPesCodigo() > ((subwconsfuncionario13) element).getPesCodigo() ) return 1;
                  if ( getPesCodigo() < ((subwconsfuncionario13) element).getPesCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getPesNome().CompareTo(((subwconsfuncionario13) element).getPesNome()) ;
               case 2 :
                  if ( getPesFunCargo() > ((subwconsfuncionario13) element).getPesFunCargo() ) return 1;
                  if ( getPesFunCargo() < ((subwconsfuncionario13) element).getPesFunCargo() ) return -1;
                  return 0;
               case 3 :
                  return GXutil.datecmp( GxConvert.AnyDateToJDate(getPesFunDatDemissao()) , GxConvert.AnyDateToJDate(((subwconsfuncionario13) element).getPesFunDatDemissao()) );
               case 4 :
                  if ( getVDemitido() > ((subwconsfuncionario13) element).getVDemitido() ) return 1;
                  if ( getVDemitido() < ((subwconsfuncionario13) element).getVDemitido() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setPesCodigo(((subwconsfuncionario13) element).getPesCodigo());
                  return;
               case 1 :
                  setPesNome(((subwconsfuncionario13) element).getPesNome());
                  return;
               case 2 :
                  setPesFunCargo(((subwconsfuncionario13) element).getPesFunCargo());
                  setPesFunCargoDescription(((subwconsfuncionario13) element).getPesFunCargoDescription());
                  return;
               case 3 :
                  setPesFunDatDemissao(((subwconsfuncionario13) element).getPesFunDatDemissao());
                  return;
               case 4 :
                  setVDemitido(((subwconsfuncionario13) element).getVDemitido());
                  return;
         }
      }
