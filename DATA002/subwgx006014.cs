...
namespace GeneXus.Programs {
   public class subwgx006014 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getMidCodigo() > ((subwgx006014) element).getMidCodigo() ) return 1;
                  if ( getMidCodigo() < ((subwgx006014) element).getMidCodigo() ) return -1;
                  return 0;
               case 1 :
                  if ( getMidTipo() > ((subwgx006014) element).getMidTipo() ) return 1;
                  if ( getMidTipo() < ((subwgx006014) element).getMidTipo() ) return -1;
                  return 0;
               case 2 :
                  if ( getMidSituacao() > ((subwgx006014) element).getMidSituacao() ) return 1;
                  if ( getMidSituacao() < ((subwgx006014) element).getMidSituacao() ) return -1;
                  return 0;
               case 3 :
                  if ( getFilCodigo() > ((subwgx006014) element).getFilCodigo() ) return 1;
                  if ( getFilCodigo() < ((subwgx006014) element).getFilCodigo() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setMidCodigo(((subwgx006014) element).getMidCodigo());
                  return;
               case 1 :
                  setMidTipo(((subwgx006014) element).getMidTipo());
                  setMidTipoDescription(((subwgx006014) element).getMidTipoDescription());
                  return;
               case 2 :
                  setMidSituacao(((subwgx006014) element).getMidSituacao());
                  setMidSituacaoDescription(((subwgx006014) element).getMidSituacaoDescription());
                  return;
               case 3 :
                  setFilCodigo(((subwgx006014) element).getFilCodigo());
                  return;
         }
      }
