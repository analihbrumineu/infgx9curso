...
namespace GeneXus.Programs {
   public class subtlocacao26 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getLocMidMidCodigo() > ((subtlocacao26) element).getLocMidMidCodigo() ) return 1;
                  if ( getLocMidMidCodigo() < ((subtlocacao26) element).getLocMidMidCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getLocMidFilNome().CompareTo(((subtlocacao26) element).getLocMidFilNome()) ;
               case 2 :
                  if ( getLocMidMidTipo() > ((subtlocacao26) element).getLocMidMidTipo() ) return 1;
                  if ( getLocMidMidTipo() < ((subtlocacao26) element).getLocMidMidTipo() ) return -1;
                  return 0;
               case 3 :
                  if ( getLocMidMidConfValor() > ((subtlocacao26) element).getLocMidMidConfValor() ) return 1;
                  if ( getLocMidMidConfValor() < ((subtlocacao26) element).getLocMidMidConfValor() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setLocMidMidCodigo(((subtlocacao26) element).getLocMidMidCodigo());
                  return;
               case 1 :
                  setLocMidFilNome(((subtlocacao26) element).getLocMidFilNome());
                  return;
               case 2 :
                  setLocMidMidTipo(((subtlocacao26) element).getLocMidMidTipo());
                  setLocMidMidTipoDescription(((subtlocacao26) element).getLocMidMidTipoDescription());
                  return;
               case 3 :
                  setLocMidMidConfValor(((subtlocacao26) element).getLocMidMidConfValor());
                  return;
         }
      }
