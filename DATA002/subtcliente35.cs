...
namespace GeneXus.Programs {
   public class subtcliente35 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getPesDepCodigo() > ((subtcliente35) element).getPesDepCodigo() ) return 1;
                  if ( getPesDepCodigo() < ((subtcliente35) element).getPesDepCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getPesDepNome().CompareTo(((subtcliente35) element).getPesDepNome()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setPesDepCodigo(((subtcliente35) element).getPesDepCodigo());
                  return;
               case 1 :
                  setPesDepNome(((subtcliente35) element).getPesDepNome());
                  return;
         }
      }
