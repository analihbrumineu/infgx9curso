...
namespace GeneXus.Programs {
   public class subwgx00g120 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getLocMidMidCodigo() > ((subwgx00g120) element).getLocMidMidCodigo() ) return 1;
                  if ( getLocMidMidCodigo() < ((subwgx00g120) element).getLocMidMidCodigo() ) return -1;
                  return 0;
               case 1 :
                  if ( getLocMidFilCodigo() > ((subwgx00g120) element).getLocMidFilCodigo() ) return 1;
                  if ( getLocMidFilCodigo() < ((subwgx00g120) element).getLocMidFilCodigo() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setLocMidMidCodigo(((subwgx00g120) element).getLocMidMidCodigo());
                  return;
               case 1 :
                  setLocMidFilCodigo(((subwgx00g120) element).getLocMidFilCodigo());
                  return;
         }
      }
