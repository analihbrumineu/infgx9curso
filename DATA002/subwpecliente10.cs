...
namespace GeneXus.Programs {
   public class subwpecliente10 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  return  getVVisualizar().CompareTo(((subwpecliente10) element).getVVisualizar()) ;
               case 1 :
                  return  getVEditar().CompareTo(((subwpecliente10) element).getVEditar()) ;
               case 2 :
                  return  getVExcluir().CompareTo(((subwpecliente10) element).getVExcluir()) ;
               case 3 :
                  if ( getPesCodigo() > ((subwpecliente10) element).getPesCodigo() ) return 1;
                  if ( getPesCodigo() < ((subwpecliente10) element).getPesCodigo() ) return -1;
                  return 0;
               case 4 :
                  return  getPesNome().CompareTo(((subwpecliente10) element).getPesNome()) ;
               case 5 :
                  if ( getPesDepTotal() > ((subwpecliente10) element).getPesDepTotal() ) return 1;
                  if ( getPesDepTotal() < ((subwpecliente10) element).getPesDepTotal() ) return -1;
                  return 0;
               case 6 :
                  if ( getPesSituacao() > ((subwpecliente10) element).getPesSituacao() ) return 1;
                  if ( getPesSituacao() < ((subwpecliente10) element).getPesSituacao() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setVVisualizar(((subwpecliente10) element).getVVisualizar());
                  return;
               case 1 :
                  setVEditar(((subwpecliente10) element).getVEditar());
                  return;
               case 2 :
                  setVExcluir(((subwpecliente10) element).getVExcluir());
                  return;
               case 3 :
                  setPesCodigo(((subwpecliente10) element).getPesCodigo());
                  return;
               case 4 :
                  setPesNome(((subwpecliente10) element).getPesNome());
                  return;
               case 5 :
                  setPesDepTotal(((subwpecliente10) element).getPesDepTotal());
                  return;
               case 6 :
                  setPesSituacao(((subwpecliente10) element).getPesSituacao());
                  setPesSituacaoDescription(((subwpecliente10) element).getPesSituacaoDescription());
                  return;
         }
      }
