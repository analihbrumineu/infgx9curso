...
namespace GeneXus.Programs {
   public class subwgx008008 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getAstCodigo() > ((subwgx008008) element).getAstCodigo() ) return 1;
                  if ( getAstCodigo() < ((subwgx008008) element).getAstCodigo() ) return -1;
                  return 0;
               case 1 :
                  return GXutil.datecmp( GxConvert.AnyDateToJDate(getAstDatNascimento()) , GxConvert.AnyDateToJDate(((subwgx008008) element).getAstDatNascimento()) );
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setAstCodigo(((subwgx008008) element).getAstCodigo());
                  return;
               case 1 :
                  setAstDatNascimento(((subwgx008008) element).getAstDatNascimento());
                  return;
         }
      }
