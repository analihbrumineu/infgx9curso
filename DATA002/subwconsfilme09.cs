...
namespace GeneXus.Programs {
   public class subwconsfilme09 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getFilCodigo() > ((subwconsfilme09) element).getFilCodigo() ) return 1;
                  if ( getFilCodigo() < ((subwconsfilme09) element).getFilCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getFilNome().CompareTo(((subwconsfilme09) element).getFilNome()) ;
               case 2 :
                  if ( getFilSituacao() > ((subwconsfilme09) element).getFilSituacao() ) return 1;
                  if ( getFilSituacao() < ((subwconsfilme09) element).getFilSituacao() ) return -1;
                  return 0;
               case 3 :
                  return GXutil.datecmp( GxConvert.AnyDateToJDate(getFilData()) , GxConvert.AnyDateToJDate(((subwconsfilme09) element).getFilData()) );
               case 4 :
                  return  getFilDescricao().CompareTo(((subwconsfilme09) element).getFilDescricao()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setFilCodigo(((subwconsfilme09) element).getFilCodigo());
                  return;
               case 1 :
                  setFilNome(((subwconsfilme09) element).getFilNome());
                  return;
               case 2 :
                  setFilSituacao(((subwconsfilme09) element).getFilSituacao());
                  setFilSituacaoDescription(((subwconsfilme09) element).getFilSituacaoDescription());
                  return;
               case 3 :
                  setFilData(((subwconsfilme09) element).getFilData());
                  return;
               case 4 :
                  setFilDescricao(((subwconsfilme09) element).getFilDescricao());
                  return;
         }
      }
