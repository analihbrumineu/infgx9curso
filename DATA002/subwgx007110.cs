...
namespace GeneXus.Programs {
   public class subwgx007110 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getPesDepCodigo() > ((subwgx007110) element).getPesDepCodigo() ) return 1;
                  if ( getPesDepCodigo() < ((subwgx007110) element).getPesDepCodigo() ) return -1;
                  return 0;
         }
         return 0;
      ...
      {
         return ( ( getPesDepCodigo() == 0 ) && ( getPesCodigo() == 0 ) )  ;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setPesDepCodigo(((subwgx007110) element).getPesDepCodigo());
                  return;
         }
      }
