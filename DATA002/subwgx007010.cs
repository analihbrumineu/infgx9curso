...
namespace GeneXus.Programs {
   public class subwgx007010 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getEstCodigo() > ((subwgx007010) element).getEstCodigo() ) return 1;
                  if ( getEstCodigo() < ((subwgx007010) element).getEstCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getEstUF().CompareTo(((subwgx007010) element).getEstUF()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setEstCodigo(((subwgx007010) element).getEstCodigo());
                  return;
               case 1 :
                  setEstUF(((subwgx007010) element).getEstUF());
                  return;
         }
      }
