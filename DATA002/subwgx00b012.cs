...
namespace GeneXus.Programs {
   public class subwgx00b012 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getMidTipo() > ((subwgx00b012) element).getMidTipo() ) return 1;
                  if ( getMidTipo() < ((subwgx00b012) element).getMidTipo() ) return -1;
                  return 0;
               case 1 :
                  if ( getCatCodigo() > ((subwgx00b012) element).getCatCodigo() ) return 1;
                  if ( getCatCodigo() < ((subwgx00b012) element).getCatCodigo() ) return -1;
                  return 0;
               case 2 :
                  if ( getConfTipValor() > ((subwgx00b012) element).getConfTipValor() ) return 1;
                  if ( getConfTipValor() < ((subwgx00b012) element).getConfTipValor() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setMidTipo(((subwgx00b012) element).getMidTipo());
                  setMidTipoDescription(((subwgx00b012) element).getMidTipoDescription());
                  return;
               case 1 :
                  setCatCodigo(((subwgx00b012) element).getCatCodigo());
                  return;
               case 2 :
                  setConfTipValor(((subwgx00b012) element).getConfTipValor());
                  return;
         }
      }
