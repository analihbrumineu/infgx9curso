...
namespace GeneXus.Programs {
   public class subwgx002008 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getFilCodigo() > ((subwgx002008) element).getFilCodigo() ) return 1;
                  if ( getFilCodigo() < ((subwgx002008) element).getFilCodigo() ) return -1;
                  return 0;
               case 1 :
                  if ( getFilSituacao() > ((subwgx002008) element).getFilSituacao() ) return 1;
                  if ( getFilSituacao() < ((subwgx002008) element).getFilSituacao() ) return -1;
                  return 0;
               case 2 :
                  return GXutil.datecmp( GxConvert.AnyDateToJDate(getFilData()) , GxConvert.AnyDateToJDate(((subwgx002008) element).getFilData()) );
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setFilCodigo(((subwgx002008) element).getFilCodigo());
                  return;
               case 1 :
                  setFilSituacao(((subwgx002008) element).getFilSituacao());
                  setFilSituacaoDescription(((subwgx002008) element).getFilSituacaoDescription());
                  return;
               case 2 :
                  setFilData(((subwgx002008) element).getFilData());
                  return;
         }
      }
