...
namespace GeneXus.Programs {
   public class subtfilme21 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getFilDirCodigo() > ((subtfilme21) element).getFilDirCodigo() ) return 1;
                  if ( getFilDirCodigo() < ((subtfilme21) element).getFilDirCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getFilDirNome().CompareTo(((subtfilme21) element).getFilDirNome()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setFilDirCodigo(((subtfilme21) element).getFilDirCodigo());
                  return;
               case 1 :
                  setFilDirNome(((subtfilme21) element).getFilDirNome());
                  return;
         }
      }
