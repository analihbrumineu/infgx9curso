...
namespace GeneXus.Programs {
   public class subtcliente39 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getPesDepCodigo() > ((subtcliente39) element).getPesDepCodigo() ) return 1;
                  if ( getPesDepCodigo() < ((subtcliente39) element).getPesDepCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getPesDepNome().CompareTo(((subtcliente39) element).getPesDepNome()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setPesDepCodigo(((subtcliente39) element).getPesDepCodigo());
                  return;
               case 1 :
                  setPesDepNome(((subtcliente39) element).getPesDepNome());
                  return;
         }
      }
