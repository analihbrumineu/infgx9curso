/*
       ...
       Generated on: 6/5/2026 9:0:23.12
...
namespace GeneXus.Programs {
   public class wreltoplist : GXWorkpanel
   {
      public wreltoplist( int hnd ,
      ...
      public wreltoplist( IGxContext context ) : base(-1, null)
      {
         this.context = context;
         IsMain = false;
      }

      public wreltoplist( IGxContext context ,
                          int hnd ,
                          ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      protected void E14V2M2( )
      {
         eventLevelContext();
         /* 'Imprimir' Routine */
         if ( ( AV12Assunt == Convert.ToDecimal( 1 )) )
         {
            new rreltoplisdevolucoes(context, base.remoteHandle, base.context).execute( ) ;
         }
      ...
      public override void screen( )
      {
         ...
         edtavDatinicial.getGXComponent().setHelpId("HLP_WRelTopList.htm");
         ...
         edtavDatfinal.getGXComponent().setHelpId("HLP_WRelTopList.htm");
         ...
         ((GXComboBox) cmbavRelatorio.getGXComponent()).addItem( new java.lang.Short(3),"Clientes");
         ((GXComboBox) cmbavRelatorio.getGXComponent()).addItem( new java.lang.Short(4),"Filmes");
         ((GXComboBox) cmbavRelatorio.getGXComponent()).addItem( new java.lang.Short(5),"Categorias");
         ((GXComboBox) cmbavRelatorio.getGXComponent()).addItem( new java.lang.Short(6),"Formatos de mídia");
         cmbavRelatorio.addFocusListener(this);
         cmbavRelatorio.addItemListener(this);
         cmbavRelatorio.getGXComponent().setHelpId("HLP_WRelTopList.htm");
         ...
         edtavSelecao.getGXComponent().setHelpId("HLP_WRelTopList.htm");
