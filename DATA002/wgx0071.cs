/*
               File: Gx0071
        Description: Lista de Seleção Dependentes
             Author: GeneXus C# Generator version 9_0_7-910
       Generated on: 4/17/2026 9:59:21.50
...
namespace GeneXus.Programs {
   public class wgx0071 : GXWorkpanel
   {
      public wgx0071( int hnd ,
      ...
      public wgx0071( IGxContext context ) : base(-1, null)
      {
      ...
      public wgx0071( IGxContext context ,
                      int hnd ,
                      ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      {
         return "Lista de Seleção Dependentes" ;
      }
      ...
      public class Gx0071_load10 : GXLoadProducer
      {
         wgx0071 _sf ;

         public Gx0071_load10( wgx0071 uType ) : base()
         {
            _sf = uType;
         }
      ...
      public class Gx0071_flow10 : GXSubfileFlow
      {
         wgx0071 _sf ;

         public Gx0071_flow10( wgx0071 uType ) : base()
         {
            _sf = uType;
         }
      ...
      {
         subwgx007110 oAux = subwgx007110 ;
         subwgx007110 = new subwgx007110 ();
         variablesToSubfile10 ();
         subGrd_1.addElement(subwgx007110);
         subwgx007110 = oAux;
      }

      private void E11V112( )
      {
         /* Load Routine */
      ...
      public override void screen( )
      {
         ...
         edtPesCodigo.getGXComponent().setHelpId("HLP_WGx0071.htm");
         ...
         edtavCpesdepcodigo.getGXComponent().setHelpId("HLP_WGx0071.htm");
         addSubfile ( subGrd_1  = new GXSubfile ( new Gx0071_load10(this), new Gx0071_flow10(this), false , new GXColumnDefinition[] {
          new GXColumnDefinition( new GUIObjectInt ( new GXEdit(9, "ZZZZZZZZ9", UIFactory.getFont( "Courier New", 0, 9),0, 0, 142, 19, GXPanel1, false, ILabelConstants.BORDER_NONE, GXTypeConstants.NUMERIC, false, false, 0, false) , null ,  0 , 0 , 141 , 18 , UIFactory.getColor(5) , UIFactory.getColor(8) , UIFactory.getFont( "Courier New", 0, 9) , false , "A46PesDepC" ), "Código do dependente."  , UIFactory.getColor(18) , UIFactory.getColor(15) , 141 , UIFactory.getFont( "MS Sans Serif", IFontConstants.BOLD, 8) , false , true )
         }, 9 , 18 , GXPanel1 , 21 , 72 , 198 , 193 ,  18 ));
         ...
         lbllbl7 = UIFactory.getLabel(GXPanel1, "Código da pessoa.", ILabelConstants.LEFT, Integer.MAX_VALUE, UIFactory.getColor(8), UIFactory.getFont( "MS Sans Serif", IFontConstants.BOLD, 8), false, ILabelConstants.BORDER_NONE , 21 , 24 , 106 , 13 );
         lbllbl9 = UIFactory.getLabel(GXPanel1, "Código do dependente.", ILabelConstants.LEFT, Integer.MAX_VALUE, UIFactory.getColor(8), UIFactory.getFont( "MS Sans Serif", IFontConstants.BOLD, 8), false, ILabelConstants.BORDER_NONE , 21 , 48 , 133 , 13 );
      ...
      {
         subwgx007110.setPesDepCodigo(A46PesDepC);
         subwgx007110.setPesCodigo(A13PesCodi);
      }

      protected void subfileToVariables10( )
      {
         A46PesDepC = subwgx007110.getPesDepCodigo();
         A13PesCodi = subwgx007110.getPesCodigo();
      }
      ...
      public override void eventLevelContext( )
      {
         ...
         {
            subwgx007110 = ( subwgx007110 ) subGrd_1.getCurrentElement() ;
         }
         else
         {
            subwgx007110 = new subwgx007110 ();
      ...
      {
         variablesToSubfile10 ();
         subGrd_1.refreshLineValue(subwgx007110);
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         AV5cPesDep = 0 ;
         W00112_A13PesCodi = new int[1] ;
         W00112_A46PesDepC = new int[1] ;
         A46PesDepC = 0 ;
         gxIsRefreshing = false ;
         cV5cPesDep = 0 ;
         returnInSub = false ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wgx0071__default(),
            new Object[][] {
                new Object[] {
               W00112_A13PesCodi, W00112_A46PesDepC
               }
            }
         );
      ...
      protected subwgx007110 subwgx007110 ;
      protected IDataReader W00112 ;
      protected IDataStoreProvider pr_default ;
      protected int[] W00112_A13PesCodi ;
      protected int[] W00112_A46PesDepC ;
   ...
   public class wgx0071__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmW00112 ;
          prmW00112 = new Object[] {
          new Object[] {"@PesCodigo",SqlDbType.Int,9,0} ,
          new Object[] {"@AV5cPesDep",SqlDbType.Int,9,0}
          } ;
          def= new GeneXus.Data.NTier.ADO.CursorDef[] {
              new GeneXus.Data.NTier.ADO.CursorDef("W00112", "SELECT [PesCodigo], [PesDepCodigo] FROM [CLIENTELEVEL1] WITH (NOLOCK) WHERE [PesCodigo] = @PesCodigo and [PesDepCodigo] >= @AV5cPesDep ORDER BY [PesCodigo], [PesDepCodigo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmW00112,9,0,true,false )
          };
       }
    }
