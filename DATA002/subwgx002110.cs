...
namespace GeneXus.Programs {
   public class subwgx002110 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getPesDepCodigo() > ((subwgx002110) element).getPesDepCodigo() ) return 1;
                  if ( getPesDepCodigo() < ((subwgx002110) element).getPesDepCodigo() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setPesDepCodigo(((subwgx002110) element).getPesDepCodigo());
                  return;
         }
      }
