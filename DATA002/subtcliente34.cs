...
namespace GeneXus.Programs {
   public class subtcliente34 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  if ( getPesDepCodigo() > ((subtcliente34) element).getPesDepCodigo() ) return 1;
                  if ( getPesDepCodigo() < ((subtcliente34) element).getPesDepCodigo() ) return -1;
                  return 0;
               case 1 :
                  return  getPesDepNome().CompareTo(((subtcliente34) element).getPesDepNome()) ;
         }
         return 0;
      }
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setPesDepCodigo(((subtcliente34) element).getPesDepCodigo());
                  return;
               case 1 :
                  setPesDepNome(((subtcliente34) element).getPesDepNome());
                  return;
         }
      }
