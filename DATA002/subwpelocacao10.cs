...
namespace GeneXus.Programs {
   public class subwpelocacao10 : GXSubfileElement
   {
                                     ...
                                     int column )
      {
         ...
         {
               case 0 :
                  return  getVMarcado().CompareTo(((subwpelocacao10) element).getVMarcado()) ;
               case 1 :
                  return  getVVisualizar().CompareTo(((subwpelocacao10) element).getVVisualizar()) ;
               case 2 :
                  return  getVEditar().CompareTo(((subwpelocacao10) element).getVEditar()) ;
               case 3 :
                  if ( getLocCodigo() > ((subwpelocacao10) element).getLocCodigo() ) return 1;
                  if ( getLocCodigo() < ((subwpelocacao10) element).getLocCodigo() ) return -1;
                  return 0;
               case 4 :
                  return GXutil.datecmp( GxConvert.AnyDateToJDate(getLocDatLocacao()) , GxConvert.AnyDateToJDate(((subwpelocacao10) element).getLocDatLocacao()) );
               case 5 :
                  if ( getLocCliPesCodigo() > ((subwpelocacao10) element).getLocCliPesCodigo() ) return 1;
                  if ( getLocCliPesCodigo() < ((subwpelocacao10) element).getLocCliPesCodigo() ) return -1;
                  return 0;
               case 6 :
                  return  getLocCliPesNome().CompareTo(((subwpelocacao10) element).getLocCliPesNome()) ;
               case 7 :
                  if ( getLocSituacao() > ((subwpelocacao10) element).getLocSituacao() ) return 1;
                  if ( getLocSituacao() < ((subwpelocacao10) element).getLocSituacao() ) return -1;
                  return 0;
         }
         return 0;
                                     ...
                                     GXSubfileElement element )
      {
         ...
         {
               case 0 :
                  setVMarcado(((subwpelocacao10) element).getVMarcado());
                  return;
               case 1 :
                  setVVisualizar(((subwpelocacao10) element).getVVisualizar());
                  return;
               case 2 :
                  setVEditar(((subwpelocacao10) element).getVEditar());
                  return;
               case 3 :
                  setLocCodigo(((subwpelocacao10) element).getLocCodigo());
                  return;
               case 4 :
                  setLocDatLocacao(((subwpelocacao10) element).getLocDatLocacao());
                  return;
               case 5 :
                  setLocCliPesCodigo(((subwpelocacao10) element).getLocCliPesCodigo());
                  return;
               case 6 :
                  setLocCliPesNome(((subwpelocacao10) element).getLocCliPesNome());
                  return;
               case 7 :
                  setLocSituacao(((subwpelocacao10) element).getLocSituacao());
                  setLocSituacaoDescription(((subwpelocacao10) element).getLocSituacaoDescription());
                  return;
         }
      }
