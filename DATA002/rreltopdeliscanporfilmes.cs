...
namespace GeneXus.Programs {
   public class rreltopdeliscanporfilmes_wrapper : GXJWin
   {
      public rreltopdeliscanporfilmes_wrapper( int hnd ,
   ...
   public class rreltopdeliscanporfilmes : GXWinProcedure
   {
      public rreltopdeliscanporfilmes( int hnd ,
                                       ModelContext jContext ) : base(hnd, jContext)
      {
         IsMain = true;
      ...
      public rreltopdeliscanporfilmes( )
      {
         context = new GxContext(  );
         DataStoreUtil.LoadDataStores( context);
         dsDefault = context.GetDataStore("Default") ;
      ...
      public rreltopdeliscanporfilmes( IGxContext context ) : base(-1, null)
      {
      ...
      public rreltopdeliscanporfilmes( IGxContext context ,
                                       int hnd ,
                                       ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      public void executeSubmit( DateTime aP0_DatInicial ,
                                 ...
                                 long aP2_Selecao )
      {
         rreltopdeliscanporfilmes objrreltopdeliscanporfilmes;
         objrreltopdeliscanporfilmes = new rreltopdeliscanporfilmes();
         objrreltopdeliscanporfilmes.AV8DatInic = aP0_DatInicial;
         objrreltopdeliscanporfilmes.AV9DatFina = aP1_DatFinal;
         objrreltopdeliscanporfilmes.AV10Seleca = aP2_Selecao;
         objrreltopdeliscanporfilmes.initialize();
         ThreadPool.QueueUserWorkItem( new WaitCallback( objrreltopdeliscanporfilmes.executePrivateCatch ));
      }
                           ...
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( ( Gx_line + Inc >= P_lines ) )
            {
               ...
               getPrinter().GxDrawText(StringUtil.RTrim( StringUtil.Format( AV19Pgmdes, "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")), 130, Gx_line+20, 506, Gx_line+35, 0) ;
      ...
      public override void initialize( )
      {
         ...
         Gx_time = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rreltopdeliscanporfilmes__default(),
            new Object[][] {
                new Object[] {
         ...
         AV19Pgmdes = "Relatório de topo de lista sobre total de cancelamentos por filme." ;
         context.Gx_err = 0 ;
   ...
   public class rreltopdeliscanporfilmes__default : DataStoreHelperBase, IDataStoreHelper
   {
