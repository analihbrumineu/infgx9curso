/*
       ...
       Generated on: 5/26/2026 9:33:37.80
...
namespace GeneXus.Programs {
   public class wgx00f0 : GXWorkpanel
   {
      public wgx00f0( int hnd ,
      ...
      public wgx00f0( IGxContext context ) : base(-1, null)
      {
      ...
      public wgx00f0( IGxContext context ,
                      int hnd ,
                      ModelContext jContext ) : base(hnd, jContext)
      {
         this.context = context;
      ...
      public void runLoad_load20( )
      {
         ...
         {
            A89LocDatD = W00242_A89LocDatD[0] ;
            n89LocDatD = W00242_n89LocDatD[0] ;
            A90LocDatC = W00242_A90LocDatC[0] ;
            n90LocDatC = W00242_n90LocDatC[0] ;
            A91LocCliP = W00242_A91LocCliP[0] ;
            n91LocCliP = W00242_n91LocCliP[0] ;
            A93LocVenP = W00242_A93LocVenP[0] ;
            n93LocVenP = W00242_n93LocVenP[0] ;
            A88LocDatL = W00242_A88LocDatL[0] ;
            n88LocDatL = W00242_n88LocDatL[0] ;
            A87LocSitu = W00242_A87LocSitu[0] ;
            n87LocSitu = W00242_n87LocSitu[0] ;
            A86LocCodi = W00242_A86LocCodi[0] ;
            /* Execute user event: E11V242 */
            E11V242 ();
      ...
      public class Gx00F0_load20 : GXLoadProducer
      {
         wgx00f0 _sf ;

         public Gx00F0_load20( wgx00f0 uType ) : base()
         {
            _sf = uType;
         }
      ...
      public class Gx00F0_flow20 : GXSubfileFlow
      {
         wgx00f0 _sf ;

         public Gx00F0_flow20( wgx00f0 uType ) : base()
         {
            _sf = uType;
         }
      ...
      {
         subwgx00f020 oAux = subwgx00f020 ;
         subwgx00f020 = new subwgx00f020 ();
         variablesToSubfile20 ();
         subGrd_1.addElement(subwgx00f020);
         subwgx00f020 = oAux;
      }

      private void E11V242( )
      {
         /* Load Routine */
      ...
      public override void screen( )
      {
         ...
         edtavCloccodigo.getGXComponent().setHelpId("HLP_WGx00F0.htm");
         ...
         cmbavClocsituacao.getGXComponent().setHelpId("HLP_WGx00F0.htm");
         ...
         edtavClocdatlocacao.getGXComponent().setHelpId("HLP_WGx00F0.htm");
         ...
         edtavClocdatdevolucao.getGXComponent().setHelpId("HLP_WGx00F0.htm");
         ...
         edtavClocdatcancelamento.getGXComponent().setHelpId("HLP_WGx00F0.htm");
         ...
         edtavClocclipescodigo.getGXComponent().setHelpId("HLP_WGx00F0.htm");
         ...
         edtavClocvenpescodigo.getGXComponent().setHelpId("HLP_WGx00F0.htm");
         addSubfile ( subGrd_1  = new GXSubfile ( new Gx00F0_load20(this), new Gx00F0_flow20(this), false , new GXColumnDefinition[] {
      ...
      {
         subwgx00f020.setLocCodigo(A86LocCodi);
         subwgx00f020.setLocSituacao(A87LocSitu);
         subwgx00f020.setLocDatLocacao(A88LocDatL);
      }

      protected void subfileToVariables20( )
      {
         A86LocCodi = subwgx00f020.getLocCodigo();
         A87LocSitu = subwgx00f020.getLocSituacao();
         A88LocDatL = subwgx00f020.getLocDatLocacao();
      }
      ...
      public override void eventLevelContext( )
      {
         ...
         {
            subwgx00f020 = ( subwgx00f020 ) subGrd_1.getCurrentElement() ;
         }
         else
         {
            subwgx00f020 = new subwgx00f020 ();
      ...
      {
         variablesToSubfile20 ();
         subGrd_1.refreshLineValue(subwgx00f020);
      }
      ...
      public override void initialize( )
      {
         ...
         AV10cLocCl = 0 ;
         AV11cLocVe = 0 ;
         W00242_A89LocDatD = new DateTime[] {DateTime.MinValue} ;
         W00242_n89LocDatD = new bool[] {false} ;
         W00242_A90LocDatC = new DateTime[] {DateTime.MinValue} ;
         W00242_n90LocDatC = new bool[] {false} ;
         W00242_A91LocCliP = new int[1] ;
         W00242_n91LocCliP = new bool[] {false} ;
         W00242_A93LocVenP = new int[1] ;
         W00242_n93LocVenP = new bool[] {false} ;
         W00242_A88LocDatL = new DateTime[] {DateTime.MinValue} ;
         W00242_n88LocDatL = new bool[] {false} ;
         W00242_A87LocSitu = new short[1] ;
         W00242_n87LocSitu = new bool[] {false} ;
         W00242_A86LocCodi = new int[1] ;
         ...
         cV11cLocVe = 0 ;
         returnInSub = false ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wgx00f0__default(),
            new Object[][] {
                new Object[] {
               W00242_A89LocDatD, W00242_n89LocDatD, W00242_A90LocDatC, W00242_n90LocDatC, W00242_A91LocCliP, W00242_n91LocCliP, W00242_A93LocVenP, W00242_n93LocVenP, W00242_A88LocDatL, W00242_n88LocDatL,
               W00242_A87LocSitu, W00242_n87LocSitu, W00242_A86LocCodi
               }
            }
         );
      ...
      protected subwgx00f020 subwgx00f020 ;
      protected IDataReader W00242 ;
      protected IDataStoreProvider pr_default ;
      protected DateTime[] W00242_A89LocDatD ;
      protected bool[] W00242_n89LocDatD ;
      protected DateTime[] W00242_A90LocDatC ;
      protected bool[] W00242_n90LocDatC ;
      protected int[] W00242_A91LocCliP ;
      protected bool[] W00242_n91LocCliP ;
      protected int[] W00242_A93LocVenP ;
      protected bool[] W00242_n93LocVenP ;
      protected DateTime[] W00242_A88LocDatL ;
      protected bool[] W00242_n88LocDatL ;
      protected short[] W00242_A87LocSitu ;
      protected bool[] W00242_n87LocSitu ;
      protected int[] W00242_A86LocCodi ;
   ...
   public class wgx00f0__default : DataStoreHelperBase, IDataStoreHelper
   {
